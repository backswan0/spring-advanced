...
class ManagerServiceTest {
    ...
    public void manager_목록_조회_시_Todo가_없다면_NPE_에러를_던진다() {
        ...
        // when & then
        InvalidRequestException exception = assertThrows(InvalidRequestException.class, () -> managerService.readAllManagers(todoId));
    ...
    void todo가_정상적으로_등록된다() {
        ...
        // when
        CreateManagerResponseDto response = managerService.createManager(authUser, todoId,
